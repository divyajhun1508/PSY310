...
expName = 'Signaldetection_experiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/purvajhunjhunwala/Desktop/lab in psychology/Signal detection/Signaldetection_experiment_lastrun.py',
