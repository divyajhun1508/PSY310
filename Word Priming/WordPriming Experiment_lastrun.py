...
expName = 'WordPriming Experiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/purvajhunjhunwala/Desktop/lab in psychology/Word Priming/WordPriming Experiment_lastrun.py',
