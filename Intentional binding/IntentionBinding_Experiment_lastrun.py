...
expName = 'IntentionBinding_Experiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/purvajhunjhunwala/Desktop/lab in psychology/Intentional binding/IntentionBinding_Experiment_lastrun.py',
